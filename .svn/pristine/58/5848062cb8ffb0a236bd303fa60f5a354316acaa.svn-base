        ...
        <div class="table-content m-t-30">
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" placeholder="输入自定义链接地址，便于优化" name="url" value="{{$data->url}}" datatype="/^[a-z]{2,30}$/" ajaxurl="/admin/getonlyinfo?type=category_url&id={{$data->id}}"  maxlength="30" tipsrmsg="请输入url地址" errormsg="url为2-30个小写英文字母" >
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" placeholder="输入标题"  name="title" value="{{$data->title}}" ignore="ignore" datatype="*3-80" tipsrmsg="请输入3-80个字符" errormsg="长度为3-80个字符">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" placeholder="输入关键词"  name="keywords" value="{{$data->keywords}}" ignore="ignore" datatype="*3-100" tipsrmsg="请输入3-100个字符" errormsg="长度为3-100个字符">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" placeholder="输入关键词描述"  name="meta_desc" value="{{$data->meta_desc}}"  ignore="ignore" datatype="*3-200" tipsrmsg="请输入3-200个字符" errormsg="长度为3-200个字符">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
