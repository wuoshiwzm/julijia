    ...
    <div class="ge_admin_nei_right">
        ...
        <div class="table_div">
            <div class="table_div_hd">
                <ul class="layui-nav">
                    <li><a href="{{url('member/order')}}">全部订单&nbsp;(&nbsp;1&nbsp;)</a>
                    </li>
                    <li class="layui-nav-item"><a href="{{url('member/order/topay')}}">等待付款&nbsp;(&nbsp;6&nbsp;)</a>
                    </li>
                    <li class="layui-nav-item"><a
                                href="{{url('member/order/toship')}}">等待发货&nbsp;(&nbsp;{{$data->count()}}&nbsp;)</a>
                    </li>
                    <li class="layui-nav-item layui-this"><a href="{{url('member/order/toreceive')}}">待收货&nbsp;(&nbsp;10&nbsp;)</a>
                    </li>
