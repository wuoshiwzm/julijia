                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="form-control-box">
                            ...
                            <input type="text" class="form-control" @if( $row->productEavToEav->is_system == 1 ) value="{{$flat->$name}}" @else value="{{$flat->productFlatToFlatDetail->$name}}" @endif name="{{$row->productEavToEav->id}}" @if( $row->productEavToEav->is_required == 0 ) ignore="ignore" @endif  maxlength="{{$row->productEavToEav->length}}" datatype="{{$row->productEavToEav->valid_rule}}"  errormsg="{{$row->productEavToEav->errormsg}}" tipsrmsg="{{$row->productEavToEav->tipgs}}" >
