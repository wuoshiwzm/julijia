...
class Home
{
    ...
    {
        $data = Cache::tags('goods')->remember('goodsdetails', $cache, function() use( $id,$cache ) {
    ...
    {
        $data = Cache::tags('goods')->remember('goodsImg', $cache, function() use( $id ) {
    ...
    {
        $data = Cache::tags('goods')->remember('goodsConfigInfo', $cache, function() use( $id, $data ) {
