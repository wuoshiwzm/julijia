        ...
        <div class="table-content m-t-30">
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" placeholder="seo-title"  name="title"  ignore="ignore" datatype="*3-80" tipsrmsg="请输入3-80个字符" errormsg="长度为3-80个字符">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" placeholder="seo-keywords"  name="keywords"  ignore="ignore" datatype="*3-100" tipsrmsg="请输入3-100个字符" errormsg="长度为3-100个字符">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" placeholder="seo-description"  name="meta_desc"  ignore="ignore" datatype="s3-200" tipsrmsg="请输入3-200个字符" errormsg="长度为3-200个字符">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
