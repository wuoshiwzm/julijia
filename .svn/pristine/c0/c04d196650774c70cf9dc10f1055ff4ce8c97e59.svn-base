            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <div>
                                <label class="control-label cur-p m-r-10"><input type="radio" name="is_hidden" value="1" >是</label>
                                <label class="control-label cur-p m-r-10"><input type="radio" name="is_hidden" value="0" checked="checked">否</label>
                            </div>
                        </div>
                    </div>
                </div>
