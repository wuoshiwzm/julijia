...
<body>
    <div class="phone">
        <h1>新增属性集</h1>
        <form class="m-form" action="{{url('admin/product/attribute_base_store')}}" method="post">
            <ul>
                <li><font>名称：</font><input name="attribute_name" type="text" class="txt" datatype="*" maxlength="15" tipsrmsg="请输入属性集名称" errormsg="输入的属性集名称不正确" ></li>
