                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <select type="text" class="form-control valid" name="status" datatype="*" >
                                    <option value="1" @if(isset($res->status)&&$res->status ==1)  selected="selected" @endif> 正常</option>
                                    <option value="0" @if(isset($res->status)&&$res->status ==0)  selected="selected" @endif>禁用</option>
                                </select>
                                <span class="Validform_checktip"></span>
                            </div>
                        </div>
