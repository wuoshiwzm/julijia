                                    ...
                                    <div class="layui-input-block box_163css">
                                        <ul class="star_ul fl">
                                            <li><a class="one-star
                                                        ...
                                                        active-star
                                                        @endif
                                                        " title="很差" star=1 href="#"></a></li>
                                            <li><a class="two-star
                                                        @if($data->leavel >= 2)
                                                        active-star
                                                        @endif
                                                        " title="差" star=2 href="#"></a></li>
                                            <li><a class="three-star
                                            @if($data->leavel >= 3)
                                                        active-star
                                                        @endif
                                                        " title="还行" star=3 href="#"></a></li>
                                            <li><a class="four-star
                                                        @if($data->leavel >= 4)
                                                        active-star
                                                        @endif
                                                        " title="好" star=4 href="#"></a></li>
                                            <li><a class="five-star
                                                        @if($data->leavel >= 5)
                                                        active-star
                                                        @endif
                                                        " title="很好" star=5 href="#"></a></li>
                                        </ul>
