            ...
            <div class="table-content m-t-30 ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text"  name="name" value="{{$data->name}}" class="form-control valid"  datatype="/^[a-z_]{3,20}$/" tipsrmsg="请输入3-20位英文字母" errormsg="3-20位英文字母">
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text"  name="length" value="{{$data->length}}" class="form-control valid" datatype="/^[1-9]\d*$/" maxlength="3" tipsrmsg="请输入1-3位正整数" errormsg="请输入1-3位正整数">
                                <span class="Validform_checktip"></span>
                            </div>
                        </div>
                    </div>
