...
@section('content')
    ...
    <div class="page">
        ...
        <form id="SystemConfigModel" class="form-horizontal" action="{{url('admin/group/'.$group->id)}}"
            ...
            <div class="table-content m-t-30">
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text" class="form-control valid w100" name="beg_ponits" value="{{$group->beg_ponits}}"> 至
                                <input type="text" class="form-control valid w100" name="end_ponits" value="{{$group->end_ponits}}">
                            </div>
                        </div>
                    </div>
                </div>
