            ...
            <div class="order-pic">
                <table cellpadding="0" cellspacing="0" class="order_tab">
                        ...
                        <td colspan="2">
                            <dl>
                                <dt><a href="##" target="_blank">
                                        <img src="{{getImgSize( 'goods', $orderItem->product_id, isset($orderItem->product->small_image)?$orderItem->product->small_image:'' ) }}"
                    ...
                    <tr>
                        ...
                        <td><font>{{!empty($orderItem->shipping_id)?$orderItem->shipping_id:'暂无数据'}}</font></td>
                    </tr>
