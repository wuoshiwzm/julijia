...
<div class="page-container">
    <div class="center">
        ...
        <div class="form-info">
            <form id=" " name=" " method="post" class="m-form" action="{{url('member/loginVerify')}}">
                {{Form::token()}}
                <div class="input-text-box">
                    <div class="form-group" style="width:600px; text-align:left;">
                        ...
                        <input type="text" class="username input-text" ignore="ignore" datatype="n"
                               ...
                               name="name" value="{{Input::old('name')}}"><span
                    ...
                    <div class="form-group" style="width:600px; text-align:left;">
                        ...
                        <input type="password" id=" " class="username input-text" name="password" ignore="ignore"
                               ...
                               value="{{Input::old('password')}}"><span class="Validform_checktip"></span>
...
<ul class="speed" id="supersized" style="visibility: visible;">
    <li class="slide-3 activeslide" style="visibility: visible; opacity: 0.941146;"><a target="_blank"><img
                    src="../images/login_bg.jpg" style="width: 1920px; height: 1075.2px; left: 0px; top: -32px;"></a>
    </li>
</ul>
