        ...
        <div class="table-content m-t-30 ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  name="name" class="form-control valid" datatype="/^[a-z_]{3,20}$/" ajaxurl="/admin/getonlyinfo?type=attrbute" tipsrmsg="请输入3-20位小写英文字母" errormsg="输入3-20位小写英文字母，可以包含下划线">
                            <span class="Validform_checktip"></span>
                        </div>
                        <div class="help-block help-block-t"><div class="help-block help-block-t">注意：添加后不可修改</div></div>
                    </div>
                </div>
            </div>
            <div class="simple-form-field">
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  name="length" class="form-control valid" datatype="varcherlength" maxlength="3" tipsrmsg="请输入1-255之间的正整数" errormsg="请输入1-255之间的正整数">
                            <span class="Validform_checktip"></span>
                        </div>
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <select class="form-control valid w200" name="valid_rule">
                                ...
                                <option value="*">检测是否有输入，可以输入任何字符，不留空即可通过验证</option>
