        ...
        <div class="table-content m-t-30">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid"  name="m_name" value="{{$data->m_name}}" ajaxurl="/admin/getonlyinfo?type=shop" datatype="s3-20" tipsrmsg="请输入长度在3-20内的汉字或字符" errormsg="长度在3-20内的汉字或字符" >
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" name="phone" value="{{$data->phone}}" datatype="tel" tipsrmsg="请输入手机号码或者固定电话" errormsg="电话格式有误" >
                            <span class="Validform_checktip "></span>
                        </div>
                    </div>
                </div>
