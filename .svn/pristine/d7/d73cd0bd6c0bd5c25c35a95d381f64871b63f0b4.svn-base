                ...
                <form class="form-horizontal form" accept-charset="UTF-8"  method="post" action="{{url('admin/product/goods')}}">
                    ...
                    <div class="simple-form-field">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    <input type="text" class="form-control" name="jingjie" datatype="n1-5"  errormsg="警戒库存为1-5位数字" tipsrmsg="请输入警戒库存" >
                    ...
                    <div class="simple-form-field">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    <input type="text" class="form-control" name="stock" datatype="n1-5"  errormsg="库存为1-5位数字" tipsrmsg="请输入库存" >
                                    <span class="Validform_checktip"></span>
                                </div>
                            </div>
                        </div>
