...
<div class="page">
    ...
    <form id="SystemConfigModel" class="form-horizontal form"  method="post"  action="{{url('admin/user/supplier')}}">
        {{ Form::token() }}
        <div class="table-content m-t-30">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text" class="form-control valid"  name="name"  ajaxurl="/admin/getonlyinfo?type=Supplier" datatype="s2-30" maxlength="30" tipsrmsg="请输入公司名称（不包含特殊字符）" errormsg="公司名称为2-30个字符（不包含特殊字符）">
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" name="yingyehao" ignore="ignore" datatype="s2-30" maxlength="20" tipsrmsg="请输入营业证" errormsg="营业证格式不正确">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" name="tel" ignore="ignore" datatype="tel"   tipsrmsg="请输入固定电话" errormsg="电话格式不正确">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid"  name="postcode" ignore="ignore" datatype="p"   tipsrmsg="请输入邮编" errormsg="邮编格式不正确">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" name="address" datatype="s4-50"   tipsrmsg="请输入公司地址（不包含特殊字符）" errormsg="公司地址为4-50个字符（不包含特殊字符）">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" name="faren" ignore="ignore" datatype="un"  maxlength="6" tipsrmsg="请输入法人" errormsg="法人格式不正确">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" name="zhuce_zijin" ignore="ignore" maxlength="11" datatype="n1-11"  tipsrmsg="请输入注册资金" errormsg="注册资金最大长度11位">&nbsp;&nbsp;万
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text" class="form-control valid"  name="bank" datatype="s2-30" maxlength="30" tipsrmsg="请输入开户行名称（不包含特殊字符）" errormsg="开户行名称2-30个字符（不包含特殊字符）">
                            <span class="Validform_checktip"></span>
                        </div>
                    </div>
                </div>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" name="bank_num" maxlength="20" datatype="n1-20"  tipsrmsg="请输入公司账号" errormsg="公司账号最大长度20位">
                            <span class="Validform_checktip"></span>
                        </div>
            ...
            <div class="simple-form-field p-b-30">
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input type="button" id="btn_submit" value="确认提交" class="btn btn-primary" onclick="addReset();">
                    </div>
                </div>
            </div>
        </div>
