...
class HomeController extends \BaseController
{
    ...
    public function GetIndex()
    {
        ...
        return $this->view('frontend.index.index',compact( 'banner','flashSale','recommend','floor','link' ));
    }
    ...
    public function GetList( $name )
    {
        ...
        return $this->view('frontend.list.index',compact( 'data','categoryName','brand','name','categoryLeavel','screen','selected','seo','link'));
    }
    ...
    public function GetDetails( $id )
    {
        ...
        }else
        {
            ...
            //SEO
            $seo = $goods['seo'];
            return $this->view('frontend.details.index',compact( 'data','carousel','configInfo','attribute','comment','price','seo'));
        }
