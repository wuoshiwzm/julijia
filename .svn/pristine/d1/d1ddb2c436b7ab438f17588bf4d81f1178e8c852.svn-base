                ...
                <form class="layui-form m-form" action="/member/refund/saveship" method="post">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="invoice_no" placeholder="请输入运单号、10到15位数字" autocomplete="off" class="layui-input w40b f_left"  datatype="*3-15" errormsg="为3-15位编码" tipsrmsg="请输入运单号">
