            ...
            <div class="table-content m-t-30">
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text" class="form-control valid w100" name="beg_points" value="{{$group->beg_points}}"> 至
                                <input type="text" class="form-control valid w100" name="end_points" value="{{$group->end_points}}">
                            </div>
                        </div>
                    </div>
                </div>
