	...
	<div class="search-term m-b-10">
		...
		<form  action="{{Request::url()}}" method="get">
			...
			<div class="simple-form-field">
				...
				<input type="button" id="btn_search" value="新增" class="btn btn-primary m-r-5" onclick="location='{{url('admin/newscate/create')}}'">
			</div>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						@endif
						@foreach($data as $a => $b)
							@if($v->news_cate_pid == $b->news_cate_id)
								{{$b->news_cate_name}}
							@endif
						@endforeach
					</td>
					...
					<td class="handle">
						<a href="{{url('admin/newscate/'.encode($v->news_cate_id).'/edit')}}">编辑</a>&nbsp;&nbsp;
						<a href="javascript:;" class="dele_d" onclick="delNewscate({{"'".encode($v->news_cate_id)."'"}});">删除</a>
					</td>
				</tr>
				@endforeach
