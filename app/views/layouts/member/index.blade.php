...
<div class="ge_admin02">
    <div class="ge_admin_nei">
        <div class="ge_admin_nei_left">
            <ul>
                <li @if(exiturl('cart'))class="c_on" @endif><a href="##"><font class="iconfont">&#x343f;</font>我的购物车</a>
                </li>
                <li @if(exiturl('order'))class="c_on" @endif><a href="{{url('member/order/all')}}"><font
                                class="iconfont">&#xe601;</font>我的订单</a></li>
                <li @if(exiturl('collect'))class="c_on" @endif><a href="{{url('member/collect')}}"><font
                                class="iconfont">&#xe637;</font>我的收藏</a></li>
                <li @if(exiturl('rank'))class="c_on" @endif><a href="{{url('member/rank')}}"><font class="iconfont">
                            &#xe682;</font>我的积分</a></li>
                <li @if(exiturl('refund'))class="c_on" @endif><a href="{{url('member/refund')}}"><font class="iconfont">
                            &#xe6be;</font>我的退款</a></li>
