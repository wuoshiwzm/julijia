    ...
    <div class="ge_admin_nei_right">
        ...
        <div class="table_div">
            ...
            <div class="table_div_hd table_div_hd_table">
                    ...
                    <table cellpadding="0" cellspacing="0" class="order_tab">
                        ...
                        @foreach($order->items as $item)
                            <tr>
                                <td>
                                    <dl>
                                        <dt><a href="##" target="_blank">
                                                <img src="../images/04.jpg" class="goods-thumb" width="60" height="60"></a>
                                        </dt>
                                ...
                                <td width="16%" class="operation"><a href="ge_admin_refund.html">退货退款</a><a href="##"
                ...
                <table cellpadding="0" cellspacing="0" class="order_tab">
                    <tr>
                        <td colspan="7" class="order_ding"><span>订单编号：<a href="#">JLJ201610100011111</a></span><span>下单时间：2016-10-10 18:00:00</span><span>订单来源：PC端</span><span>订单金额：100.00</span><span>优惠金额：<font>100.00</font></span><span>订单状态：待付款</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="8%">100</td>
                        <td width="12%">待付款</td>
                        <td width="16%" class="operation"><a class="dele_d" href="javascript:void(0)">删除</a></td>
                        <td width="16%"><font class="price_y">98.00</font>98.00</td>
                        <td width="14%" class="operation"><a href="##">详情</a></td>
                    </tr>
                </table>
                <div id="paging">
